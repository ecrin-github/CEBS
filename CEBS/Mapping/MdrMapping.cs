...
using DatasetConsent = CEBS.Models.MDR.Object.DatasetConsent;
using DatasetDeidentLevel = CEBS.Models.MDR.Object.DatasetDeidentLevel;
using DatasetRecordKeys = CEBS.Models.MDR.Object.DatasetRecordKeys;
...
public class MdrMapping : IMdrMapping
{
    ...
    public ObjectContributorListResponse[] MapObjectContributors(ObjectContributor[] objectContributors)
    {
        return objectContributors.Select(oc => new ObjectContributorListResponse()
        {
            ...
            Organisation = new Contracts.Responses.MDR.DTO.v1.Common.ContribOrg
            {
                Id = oc.Organisation?.Id,
                Name = oc.Organisation?.Name,
                RorId = oc.Organisation?.RorId
            },
            Person = new Contracts.Responses.MDR.DTO.v1.Common.Person
            {
    ...
    public Contracts.Responses.MDR.DTO.v1.Common.DatasetRecordKeys MapDatasetRecordKeys(
        DatasetRecordKeys datasetRecordKeys)
    {
        return new Contracts.Responses.MDR.DTO.v1.Common.DatasetRecordKeys()
        {
    ...
    public Contracts.Responses.MDR.DTO.v1.Common.DatasetDeidentLevel MapDatasetDeidentLevel(
        DatasetDeidentLevel datasetDeidentLevel)
    {
        return new Contracts.Responses.MDR.DTO.v1.Common.DatasetDeidentLevel()
        {
    ...
    public Contracts.Responses.MDR.DTO.v1.Common.DatasetConsent MapDatasetConsent(DatasetConsent datasetConsent)
    {
        return new Contracts.Responses.MDR.DTO.v1.Common.DatasetConsent()
        {
    ...
    public ObjectDateListResponse[] MapObjectDates(ObjectDate[] objectDates)
    {
        return objectDates.Select(od => new ObjectDateListResponse()
        {
            ...
            StartDate = new Contracts.Responses.MDR.DTO.v1.Common.Date
            {
                Year = od.StartDate?.Year,
                Month = od.StartDate?.Month,
                Day = od.StartDate?.Day
            },
            EndDate = new Contracts.Responses.MDR.DTO.v1.Common.Date
            {
    ...
    public ObjectInstanceListResponse[] MapObjectInstances(ObjectInstance[] objectInstances)
    {
        return objectInstances.Select(oi => new ObjectInstanceListResponse()
        {
            ...
            AccessDetails = new Contracts.Responses.MDR.DTO.v1.Common.InstanceAccessDetails
            {
                DirectAccess = oi.AccessDetails?.DirectAccess,
                Url = oi.AccessDetails?.Url,
                UrlLastChecked = oi.AccessDetails?.UrlLastChecked
            },
            ResourceDetails = new Contracts.Responses.MDR.DTO.v1.Common.InstanceResourceDetails()
            {
    ...
    public ObjectListResponse BuildElasticsearchObjectResponse(DataObject dataObject)
    {
        return new ObjectListResponse()
        {
            ...
            ManagingOrganisation = new Contracts.Responses.MDR.DTO.v1.Common.ManagingOrg
            {
            ...
            AccessDetails = new Contracts.Responses.MDR.DTO.v1.Common.AccessDetails
            {
