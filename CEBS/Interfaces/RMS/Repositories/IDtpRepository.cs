...
public interface IDtpRepository
{
    ...
    Task<BaseResponse<Dtp>> GetRecentDtp(int limit);
    ...
    Task<BaseResponse<Dta>> CreateDta(int dtpId, Dta dta);
    ...
    Task<BaseResponse<DtpDataset>> CreateDtpDataset(string objectId, DtpDataset dtpDataset);
    ...
    Task<BaseResponse<DtpObject>> CreateDtpObject(int dtpId, string objectId, DtpObject dtpObject);
    ...
    Task<BaseResponse<DtpStudy>> CreateDtpStudy(int dtpId, string studyId, DtpStudy dtpStudy);
