...
public interface IDupRepository
{
    ...
    Task<BaseResponse<Dup>> GetRecentDup(int limit);
    ...
    Task<BaseResponse<DupObject>> CreateDupObject(int dupId, DupObject dupObject);
    ...
    Task<BaseResponse<DupPrereq>> CreateDupPrereq(int dupId, DupPrereq dupPrereq);
    ...
    Task<BaseResponse<SecondaryUse>> CreateSecondaryUse(int dupId, SecondaryUse secondaryUse);
    ...
    Task<BaseResponse<Dua>> CreateDua(int dupId, Dua dua);
